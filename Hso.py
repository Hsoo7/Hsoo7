...
@scsss7.on(events.NewMessage(outgoing=True, pattern=r"\.الاوامر"))
async def _(event):
    await event.edit(commands)

@scsss7.on(events.NewMessage(outgoing=True, pattern=r"\.فحص"))
async def _(event):
...
☆ DATE : `{m9zpi}`
☆ ID : `{event.sender_id}`
☆ SOURCE SYTHON : @scsss7**
-قـم بأرسال `.الاوامر`
''')


@scsss7.on(events.NewMessage(outgoing=True, pattern=r"\.م1"))
async def _(event):
    start = datetime.datetime.now()
    await event.edit(sec1)


@scsss7.on(events.NewMessage(outgoing=True, pattern=r"\.م2"))
async def _(event):
    start = datetime.datetime.now()
    await event.edit(sec2)


@scsss7.on(events.NewMessage(outgoing=True, pattern=r"\.م3"))
async def _(event):
    start = datetime.datetime.now()
    await event.edit(sec3)


@scsss7.on(events.NewMessage(outgoing=True, pattern=r"\.م4"))
async def _(event):
    start = datetime.datetime.now()
...
@scsss7.on(events.NewMessage(outgoing=True, pattern=r"\.اعادة تشغيل"))
async def update(event):
    await event.edit("• جارِ اعادة تشغيل السورس ..\n• انتضر 1-2 دقيقة  .")
    await sython.disconnect()
    await sython.send_message("me", "`اكتملت اعادة تشغيل السورس !`")

@scss7.on(events.NewMessage(outgoing=True, pattern=r"\.تجميع المليار"))
async def _(event):
...
@scsss7.on(events.NewMessage(outgoing=True, pattern=r"\.تجميع الجوكر"))
async def _(event):
        await event.edit("حسنا, تأكد من انك مشترك ب قنوات الاشتراك الاجباري لتجنب الأخطأء")
        ...
        for i in range(100):
            ...
            try:
                ...
                await hso.send_message(event.chat_id, f"خطأ من المحتمل تم حظر الانضمام ")
                break
        await hso.send_message(event.chat_id, "تم الانتهاء من التجميع !")
...
@scsss7.on(events.NewMessage(outgoing=True, pattern=".احسب (.*)"))
async def _(event):
    try:
...
@scsss7.on(events.NewMessage(outgoing=True, pattern=".للكروبات(?: |$)(.*)"))
...
@scsss7.on(events.NewMessage(outgoing=True, pattern=".للخاص(?: |$)(.*)"))
async def gucast(event):
    Scsss7 = event.pattern_match.group(1)
    if sython:
        msg = sython
    elif event.is_reply:
        msg = await event.get_reply_message()
...
@scsss7.on(events.NewMessage(outgoing=True, pattern=".تكرار (.*)"))
...
@scss7.on(events.NewMessage(outgoing=True, pattern=".مؤقت (.*)"))
async def spammer(event):
...
@scss7.on(events.NewMessage(outgoing=True, pattern=".سورس"))
async def _(event):
      await event.reply("""السـورس يعمـل | 𝐒𝐘𝐓𝐇𝐎𝐍
╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍
- المطور : ابو علـي | SOMY
- سورس بسيط يحتوي على الاوامر المهمة التي تحتاجها
قناة السورس : https://t.me/scsss7
╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍"""
)

@Scss7.on(events.NewMessage(outgoing=True, pattern=".مطور"))
async def _(event):
      await event.reply("""SY OWNER : @T_4_Z"""
)

@scss7.on(events.NewMessage(outgoing=True, pattern=".حلويات"))
async def _(event):
...
@scss7.on(events.NewMessage(outgoing=True, pattern=".قلوب"))
async def _(event):
...
@scss7.on(events.NewMessage(outgoing=True, pattern=".العد التنازلي"))
async def _(event):
    animation_interval = 0.3
    animation_ttl = range(54)
    event = await event.edit("🔟")
...
@scss7.on(events.NewMessage(outgoing=True, pattern=".قمر"))
async def _(event):
...
@scss7.on(events.NewMessage(outgoing=True, pattern=".قمور"))
async def _(event):
...
print("- hso Userbot Running ..")
@scss7.run_until_disconnected()
